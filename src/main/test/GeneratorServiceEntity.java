package cn.com.polycis.generator;
...
public class GeneratorServiceEntity {
    ...
    public static void main(String[] args) {
        String packageName = "cn.com.polycis.api.nb.puls";
...
//"lo_network_server","lo_network_system","lo_network_config","lo_network_config_info"
    private void generateByTables(boolean serviceNameStartWithI, String packageName, String... tableNames) {
        ...
        String dbUrl = "jdbc:mysql://192.168.10.156:3306/polycis_ns_device";
       ...
       // strategyConfig.entityTableFieldAnnotationEnable(true);//生成实体类属性的对应数据库字段注解
        ...
        config.setOutputDir("D:\\polycis\\polycis_iot_platform\\polycis_ns_dev_register\\src\\main\\java");
                ...
                .setCfg(
                        ...
                        new InjectionConfig() {
                            ...
                            public String outputFile(TableInfo tableInfo) {
                                ...
                                return "D:\\polycis\\polycis_iot_platform\\polycis_ns_dev_register"+"/src/main/resources/mybatis/dev/" + tableInfo.getEntityName() + "Mapper.xml";
                        }
                        }))
